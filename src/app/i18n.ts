...
const UI = {
  ...
  pdfTabEdit: { zh: '编辑', en: 'Edit' },
  pdfTabPage: { zh: '页面', en: 'Page' },
  pdfTabAnnotate: { zh: '批注', en: 'Annotate' },
  pdfTabConvert: { zh: '转换', en: 'Convert' },
  pdfTabProtect: { zh: '保护', en: 'Protect' },
  pdfTabTools: { zh: '工具', en: 'Tools' },
  pdfToWord: { zh: 'PDF 转 Word', en: 'PDF to Word' },
  pdfToExcel: { zh: 'PDF 转 Excel', en: 'PDF to Excel' },
  pdfToPpt: { zh: 'PDF 转 PPT', en: 'PDF to PPT' },
  pdfLocalFile: { zh: '本地文件', en: 'Local file' },
  pdfThumbs: { zh: '缩略图', en: 'Thumbnails' },
  pdfHandTool: { zh: '手型', en: 'Hand' },
  pdfSelectTool: { zh: '选择', en: 'Select' },
  pdfLayoutContinuous: { zh: '连续阅读', en: 'Continuous' },
  pdfLayoutSingle: { zh: '单页', en: 'Single page' },
  pdfFileMenu: { zh: '文件', en: 'File' },
  pdfFileOpen: { zh: '打开', en: 'Open' },
  pdfFileExportAs: { zh: '导出 PDF 为', en: 'Export PDF as' },
  pdfFileCompress: { zh: '减小 PDF 大小', en: 'Reduce PDF size' },
  pdfFilePrint: { zh: '打印', en: 'Print' },
  pdfFileRecent: { zh: '最近使用', en: 'Recent' },
  pdfFileRecentEmpty: { zh: '还没有最近的 PDF', en: 'No recent PDFs yet' },
  pdfExportImage: { zh: '图片', en: 'Images' },
  pdfExportText: { zh: '纯文本', en: 'Plain text' },
  ...
  pdfTaskOk: { zh: '确定', en: 'OK' },
  pdfTaskAddFiles: { zh: '添加文件…', en: 'Add files…' },
  pdfTaskExtraFiles: { zh: '其他文件', en: 'Additional files' },
  pdfTaskNeedFiles: { zh: '请先添加所需的其他文件', en: 'Add the required extra files first' },
  pdfTaskDone: { zh: '已完成', en: 'Done' },
  pdfTaskApplied: { zh: '已应用到文档', en: 'Applied to document' },
  pdfTaskAppliedSaveHint: {
    zh: '结果已写入当前标签页，请 ⌘S / Ctrl+S 保存到磁盘',
    en: 'Result is in this tab — press ⌘S / Ctrl+S to save to disk',
  },
  pdfTaskCloseAfter: { zh: '应用后关闭', en: 'Close after apply' },
  pdfFileSize: { zh: '大小', en: 'Size' },
  pdfTaskQuickBody: {
    zh: '将使用默认选项对当前文档执行此功能。需要改参数时点「更多选项」。',
    en: 'Apply this tool to the open document with default options. Use More options to change settings.',
  },
  pdfTaskMoreOptions: { zh: '更多选项', en: 'More options' },
  run: { zh: '开始处理', en: 'Run' },
