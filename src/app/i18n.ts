...
const UI = {
  ...
  installLibreOffice: { zh: '安装本地编辑器', en: 'Install local editor' },
  downloadLibreOffice: { zh: '打开官方下载', en: 'Open official download' },
  locateInstalled: { zh: '选择已安装程序', en: 'Locate installation' },
  afterInstallDetect: { zh: '安装后重新检测', en: 'Detect after install' },
  continuePdfOnly: { zh: '暂时只使用 PDF', en: 'Continue with PDF only' },
  officeSetupTitle: { zh: '启用 Word、Excel 和 PPT 编辑', en: 'Enable Word, Excel and PowerPoint editing' },
  officeSetupHelp: {
    zh: 'Magies Office 使用免费的 LibreOffice 在本机创建和编辑 Office 文档。文件不会上传。',
    en: 'Magies Office uses free LibreOffice to create and edit Office documents locally. Files are never uploaded.',
  },
  officeSetupStepDownload: { zh: '从 LibreOffice 官方网站下载安装程序。', en: 'Download the installer from the official LibreOffice website.' },
  officeSetupStepInstall: { zh: '按系统提示完成安装。', en: 'Complete installation using the system prompts.' },
  officeSetupStepDetect: { zh: '返回这里点击“安装后重新检测”。', en: 'Return here and click “Detect after install”.' },
